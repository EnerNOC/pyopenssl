...
from OpenSSL.SSL import SSLv2_METHOD, SSLv3_METHOD, SSLv23_METHOD, TLSv1_2_METHOD
...
class _LoopbackMixin:
    ...
    def _loopbackClientFactory(self, socket):
        client = Connection(Context(TLSv1_2_METHOD), socket)
...
class ContextTests(TestCase, _LoopbackMixin):
    ...
    def test_method(self):
        ...
        :py:obj:`SSLv3_METHOD`, :py:obj:`SSLv23_METHOD`, or :py:obj:`TLSv1_2_METHOD`.
        """
        for meth in [SSLv3_METHOD, SSLv23_METHOD, TLSv1_2_METHOD]:
            Context(meth)
    ...
    def test_type(self):
        ...
        self.assertConsistentType(Context, 'Context', TLSv1_2_METHOD)
    ...
    def test_set_info_callback(self):
        ...
        clientSSL = Connection(Context(TLSv1_2_METHOD), client)
    ...
    if platform == "win32":
        ...
        def test_set_default_verify_paths(self):
            ...
            # Arg, verisign.com doesn't speak TLSv1_2
...
class ServerNameCallbackTests(TestCase, _LoopbackMixin):
    ...
    def test_no_servername(self):
        ...
        client = Connection(Context(TLSv1_2_METHOD), None)
        client.set_connect_state()
...
class ConnectionTests(TestCase, _LoopbackMixin):
    ...
    def test_get_context_wrong_args(self):
        ...
        arguments.
        """
        connection = Connection(Context(TLSv1_2_METHOD), None)
    ...
    def test_set_context_wrong_args(self):
        ...
        self.assertRaises(
            TypeError, connection.set_context, Context(TLSv1_2_METHOD), 2)
    ...
    def test_set_context(self):
        ...
        replacement = Context(TLSv1_2_METHOD)
    ...
    def test_set_tlsext_host_name_wrong_args(self):
        ...
        """
        conn = Connection(Context(TLSv1_2_METHOD), None)
    ...
    def test_connect_wrong_args(self):
        ...
        """
        connection = Connection(Context(TLSv1_2_METHOD), socket())
    ...
    def test_connect(self):
        ...
        clientSSL = Connection(Context(TLSv1_2_METHOD), socket())
...
class MemoryBIOTests(TestCase, _LoopbackMixin):
    ...
    def _server(self, sock):
        ...
        # - use TLSv1_2, use a particular certificate, etc.
